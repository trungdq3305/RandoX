...
export default function RandomWheel() {
  ...
  const { data: wheelDetail, isFetching } = useGetWheelByIdQuery(selectedWheelId!, {
              ...
              wheels?.map((wheel) => {
                ...
                return (
                  <div className="wheel-box" key={wheel.id}>
                    ...
                    <button className="detail-button" onClick={() => handleDetailClick(wheel.id)}>
                      Detail
                    </button>
                    <img
                      ...
                      alt={wheel.name}
                    />
                    <button className="random-button" onClick={() => handleSpinClick(wheel)}>
                      Draw now
                    </button>
            ...
            {isLoadingHistory ? (
              ...
              <Table
                ...
                columns={[
                  ...
                  { title: 'Reward', dataIndex: 'rewardName', key: 'rewardName' },
          ...
          <>
            ...
            <Table
              columns={[
                ...
                { title: 'Price value (VNĐ)', dataIndex: 'rewardValue', key: 'rewardValue' },
                {
                  title: 'Ratio (%)',
