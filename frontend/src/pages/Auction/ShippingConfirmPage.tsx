...
const ShippingConfirmPage: React.FC = () => {
  ...
  const onFinish = async (values: { address: string }) => {
    try {
      await confirmShipping({ sessionId: sessionId!, address: values.address }).unwrap();
  ...
  return (
    <div style={{ maxWidth: 600, margin: '0 auto' }}>
      ...
      <Paragraph>
        Bạn là người chiến thắng trong phiên đấu giá. Vui lòng xác nhận địa chỉ để chúng tôi tiến hành giao hàng.
      </Paragraph>
