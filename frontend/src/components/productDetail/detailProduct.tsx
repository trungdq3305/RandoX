    ...
    const shipping = (
        <>
            ...
            <ul style={{ listStyleType: 'none', paddingLeft: '0', fontSize: '14px' }}>
                <li style={{ marginBottom: '10px' }}><strong>Standard Shipping</strong> (15-30 working days)</li>
                <li style={{ marginBottom: '10px' }}><strong>Expedited Shipping</strong> (3-7 working days)</li>
            </ul>

            <p style={{ color: '#333', fontSize: '16px' }}>2. Defects:</p>
            <ul style={{ listStyleType: 'none', paddingLeft: '0', fontSize: '14px' }}>
                <li style={{ marginBottom: '10px' }}>
                    (1) Limited items don't have an exchange service. If you find a serious defect in the item, contact{' '}
                    <a href="mailto:support@popmart.com" style={{ color: '#0066cc', textDecoration: 'none' }}>
                        support@popmart.com
                    </a>, with the related order number and unpacking video of the figurine within seven(7) days of receiving the product.
                </li>
                <li style={{ marginBottom: '10px' }}>
            ...
            <ul style={{ listStyleType: 'none', paddingLeft: '0', fontSize: '14px' }}>
                <li style={{ marginBottom: '10px' }}>For international express shipments, the buyer shall bear any Customs Duty costs.</li>
            </ul>

            <p style={{ color: '#333', fontSize: '16px' }}>4. Stock Availability:</p>
            <ul style={{ listStyleType: 'none', paddingLeft: '0', fontSize: '14px' }}>
                <li style={{ marginBottom: '10px' }}>Due to special circumstances with the products, there might be occasions where items are out of stock.</li>
            </ul>

            <p style={{ color: '#333', fontSize: '16px' }}>5. Stock Shortages:</p>
            <ul style={{ listStyleType: 'none', paddingLeft: '0', fontSize: '14px' }}>
                <li style={{ marginBottom: '10px' }}>In the event of stock shortages, the unavailable items will be automatically refunded, and the rest of your order will be dispatched as usual.</li>
            </ul>

            <p style={{ color: '#333', fontSize: '16px' }}>6. Notice:</p>
            <ul style={{ listStyleType: 'none', paddingLeft: '0', fontSize: '14px' }}>
                <li style={{ marginBottom: '10px' }}>To ensure fast and safe delivery of this item, we will match the best logistics channel for you. Shipping fees will be automatically calculated at checkout page based on the weight, dimensions, and delivery distance of the product.</li>
            </ul>
        </>
    );
