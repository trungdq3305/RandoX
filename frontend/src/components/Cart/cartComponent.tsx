...
const CartPage: React.FC = () => {
    ...
    const { data: voucherList, isLoading: isVoucherLoading } = useGetVoucherListQuery<VoucherListResponse>({
        pageNumber: 1,
        pageSize: 10,
    });
    ...
    const handlePurchase = async () => {
        try {
            const orderResponse = await createOrder({ shippingCost: 10000, voucherId: voucherId || '' }).unwrap();
                ...
                <div>
                    <div className="actions">
                        <Button
                            ...
                            style={{ background: '#ff4d4f', borderColor: '#ff4d4f', alignSelf: "center" }}
